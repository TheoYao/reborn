$(document).ready(function() {
    ...
    function loadNews() {
        $.ajax({
            ...
            url: "json/getNews.json?time=1526522232.json",
            dataType: 'json',
            success: function (data) {
                ...
                for(var i=0; i<data.length&&i<maxNewsLength; i++) {
                    ...
                    if (newsId == 11 || newsId == 10 || newsId == 2) {
                        ...
                        htmlStr += ("<div class=\"image-locate\"><img src=\"images/info_card/info_card"+newsId+".jpg?time=1526522232.jpg\"></div></div></div>");
                    }
                    else{
